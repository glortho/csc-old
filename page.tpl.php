...
<div id="menuarea"><?php print render ($page['menuarea']) ; ?></div>
<div id="maindiv">
		<?php if ($page['sidebar_first']): ?>
        <div id="leftcontent"><?php print render($page['sidebar_first']) ; ?></div>
        <?php endif; ?>
            <div id="midcontent">
            <?php if ($breadcrumb && strpos($title, '|') === false): ?>
            ...
            <div id="rightcontent"><?php print render($page['sidebar_second']) ; ?></div>
        	<?php endif; ?>
</div>
</div>
